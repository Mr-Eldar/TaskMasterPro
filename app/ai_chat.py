...
async def start_chat(message: Message, state: FSMContext):
    ...
    await message.answer('📜 ПРИМЕРЫ, ЧТО Я МОГУ СДЕЛАТЬ ДЛЯ ТЕБЯ:\n'
    ...
    '<b>- "Мне лень учиться, что делать?"</b> → "Лень — тёмная сторона. Возьми печенье и начни с 5 минут. "Только 5 минут!", — говори сам себе. "А там и час пролетит!"', parse_mode=ParseMode.HTML)
    await message.answer('💬 КАК СО МНОЙ ОБЩАТЬСЯ:\n'
    ...
    '- Нужен мотивационный пинок? Напиши: <b>"Йода, я всё бросил, помоги!"</b> → "НЕТ! Поднимайся, падаван! Сегодня решаем хотя бы 3 задачи!"', parse_mode=ParseMode.HTML)
    ...
    '- Отдыхай! <b>"Даже Йода спит по 4 часа (ну ладно, 2… но ты спи больше!)."</b>', parse_mode=ParseMode.HTML)
