...
async def start_chat(message: Message, state: FSMContext):
    ...
    await message.answer('<b>Но знай я храню память только в в одном чате если ты закончишь диалог то я забуду о чем мы говорили. Уж прости мне уже 900 лет как ни как.</b>')
